...
RUNNER="$OUTDIR/uplop3_int64_atomic_cubin_driver_runner"
mkdir -p "$OUTDIR"

g++ -std=c++20 -O2 \
    "$ROOT/runners/uplop3_int64_atomic_cubin_driver_runner.cpp" \
    -I/opt/cuda/include -L/opt/cuda/lib64 -lcuda -ldl -o "$RUNNER"

SUMMARY="$OUTDIR/summary.txt"
{
    echo "uplop3_int64_atomic_cubin_pattern_matrix"
    echo "========================================"
    echo
    echo "kernel=$KERNEL"
    echo
