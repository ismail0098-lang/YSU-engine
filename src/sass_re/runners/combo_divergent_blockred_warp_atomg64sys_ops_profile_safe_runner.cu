...
int main(int argc, char **argv) {
    ...
    *d_xor = 0ull;
    ...
    for (int i = 0; i < 16; ++i) {
        probe_combo_divergent_blockred_warp_atomg64sys_ops_profile_safe<<<1, threads>>>(
    ...
    printf("combo_divergent_blockred_warp_atomg64sys_ops_profile_safe_ms=%.6f\n", ms);
    printf("combo_divergent_blockred_warp_atomg64sys_ops_profile_safe_iters=%d\n", iters);
    printf("combo_divergent_blockred_warp_atomg64sys_ops_profile_safe_checksum=0x%016llx\n",
