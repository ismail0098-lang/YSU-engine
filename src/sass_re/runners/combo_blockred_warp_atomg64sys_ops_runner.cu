...
probe_combo_blockred_warp_atomg64sys_ops_cache_wombo(
...
int main(int argc, char **argv) {
    ...
    *d_xor = init_xor;
    ...
    for (int i = 0; i < 20; ++i) {
        probe_combo_blockred_warp_atomg64sys_ops_cache_wombo<<<1, threads>>>(
    ...
    printf("combo_blockred_warp_atomg64sys_ops_ms=%.6f\n", ms);
    printf("combo_blockred_warp_atomg64sys_ops_iters=%d\n", iters);
    printf("combo_blockred_warp_atomg64sys_ops_checksum=0x%016llx\n",
